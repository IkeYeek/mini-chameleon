...
\begin{figure}[H]
    ...
    \label{fig:placeholder}
\end{figure}
Nous voyons que sur trois cas nous battons OpenBLAS pour des matrices hautes et fines, et globalement nous tournons autour des 50\% des performances d'OpenBLAS en séquentiel. La taille de la dimension $M$ semble jouer un rôle particulièrement important ce qui est cohérent avec le fait que si $M\leq MC$, alors on fait un dgemm scalaire.\section{Mémoire partagée - OpenMP}
