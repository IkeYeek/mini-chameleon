Nous avons dans un premier temps essayé de rendre notre implémention parallèle. Pour cela, il est nécessaire de s'intéresser aux problèmes posés par les tableaux de travail de $A$ et $B$, alloués une fois dans la fonction goto\_dgemm et passés aux sous fonctions.\\
...
\begin{figure}
    \centering
    \includegraphics[width=\columnwidth]{assets/gemm_omp.png}
