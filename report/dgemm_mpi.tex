...
d'implémenter le papier \textit{SUMMA: Scalable Universal Matrix Multiplication Algorithm}\cite{SUMMA}. Nous avons donc réalisé une première version naïve de l'algorithme nous permettant
...
le nécessitant au travers d'une seule communication. Pour ce faire on utilise un communicateur pour chaque ligne et chaque colonne de la matrice. Nous avons également décidé
...
\begin{figure}
    \centering
    \includegraphics[width=\columnwidth]{assets/dgemm_mpi/MPI_vs_OMP.png}
...
\begin{figure}
    \centering
    \includegraphics[width=\columnwidth]{assets/dgemm_mpi/strong_one_node.png}
...
\begin{figure}
    \centering
    \includegraphics[width=\columnwidth]{assets/dgemm_mpi/block_size.png}
...
\begin{figure}
    \centering
    \includegraphics[width=\columnwidth]{assets/dgemm_mpi/strong_vendor.png}
