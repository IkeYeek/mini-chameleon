...
\begin{frame}[t]{Baseline: Results}
    \begin{center}
        \includegraphics[height=.85\textheight]{res/cuda_baseline_16:9.png}
...
\begin{frame}[t]{Larger TiledMMA optimization: Results}
    \begin{center}
        \includegraphics[height=.85\textheight]{res/cuda_baseline_m8n8k8_16:9.png}
...
\begin{frame}[t]{Vectorized copies optimization: Results}
    \begin{center}
        \includegraphics[height=.85\textheight]{res/cuda_baseline_m8n8k8_128b_16:9.png}
...
\begin{frame}[t]{Larger tiled MMA optimization: Results}
    \begin{center}
        \includegraphics[height=.85\textheight]{res/cuda_baseline_m64n64k32_128b_16:9.png}
...
\begin{frame}[t]{Block tiling optimization: Results}
    \begin{center}
        \includegraphics[height=.85\textheight]{res/cuda_baseline_m64n64k32_128b_4W_16:9.png}
...
\begin{frame}[t]{Caching policy optimization: Results}
    \begin{center}
        \includegraphics[height=.85\textheight]{res/cuda_baseline_m64n64k32_128b_4W_CG_16:9.png}
