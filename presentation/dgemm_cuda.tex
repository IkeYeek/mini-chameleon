...
\begin{frame}[t]{Baseline: Results}
    \begin{center}
        \includegraphics[width=0.80\textwidth]{res/cuda_baseline.png}
...
\begin{frame}[t]{Larger TiledMMA optimization: Results}
    \begin{center}
        \includegraphics[width=0.80\textwidth]{res/cuda_baseline_m8n8k8.png}
...
\begin{frame}[t]{Vectorized copies optimization: Results}
    \begin{center}
        \includegraphics[width=0.80\textwidth]{res/cuda_baseline_m8n8k8_128b.png}
...
\begin{frame}[t]{Larger tiled MMA optimization: Results}
    \begin{center}
        \includegraphics[width=0.80\textwidth]{res/cuda_baseline_m64n64k32_128b.png}
...
\begin{frame}[t]{Block tiling optimization: Results}
    \begin{center}
        \includegraphics[width=0.80\textwidth]{res/cuda_baseline_m64n64k32_128b_4W.png}
...
\begin{frame}[t]{Caching policy optimization: Results}
    \begin{center}
        \includegraphics[width=0.80\textwidth]{res/cuda_baseline_m64n64k32_128b_4W_CG.png}
