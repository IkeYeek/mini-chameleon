...
#+begin_src bash
guix shell --pure -D mini-chameleon --with-input=slurm=slurm@22 bash gcc-toolchain emacs nano vim --tune -- bash --norc
#+end_src
...
** De manière implicite (le plus simple)
  ...
  #+begin_src bash :results output :exports both
    guix shell --pure -D mini-chameleon --with-input=slurm=slurm@22 --with-input=openblas=mkl bash emacs nano vim -- bash --norc
  #+end_src
...
** Avec un compilateur récent (utile pour la vectorisation p. ex.)
  ...
  #+begin_src bash :results output :exports both
    guix shell --pure -D mini-chameleon --with-input=slurm=slurm@22 --with-input=openblas=mkl bash gcc-toolchain emacs nano vim -- bash --norc
  #+end_src
  ...
  #+begin_src bash :results output :exports both
    guix shell --pure -D mini-chameleon --with-input=slurm=slurm@22 --with-input=openblas=mkl bash clang-toolchain emacs nano vim -- bash --norc
  #+end_src
...
#+begin_src bash
guix shell --pure mini-chameleon --with-input=slurm=slurm@22 --tune
#+end_src
...
#+begin_src bash
guix shell --pure mini-chameleon --with-input=slurm=slurm@22 --tune=haswell
#+end_src
