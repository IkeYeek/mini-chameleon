...
** channels
  ...
  dans ~./is328-students/channels.scm~:

  #+begin_src bash
    cp ./is328-students/channels.scm ~/.config/guix/channels.scm
  #+end_src
  ...
  #+begin_src scheme :tangle channels.scm
    (list (channel
           ...
           (commit
            "122396075f12b013b6bde56dafb895587b95bc9d")
           (introduction
          ...
          (channel
           ...
           (commit
            "c14b2a0231408cb5b30b7b3ba628db168960da44"))
          (channel
           (name 'guix-hpc)
           (url "https://gitlab.inria.fr/guix-hpc/guix-hpc.git")
           (commit
            "d5f1391f419affbb2889212e0d436069cb0ec473")))
  #+end_src
  ...
  support explicite d'[[https://gitlab.inria.fr/cours-mf/is328-students/is328][is328]] alias [[https://gitlab.inria.fr/guix-hpc/guix-hpc/-/commit/7677837d832d59f404cefd732de63a8f710ffec4][mini-chameleon]], et le *16 novembre 2021* pour
  le [[https://git.savannah.gnu.org/cgit/guix.git/commit/?id=2a32c99b387cec52d586007172f419630d79bc6b][support de =libomp= automatique avec =clang=]].
