...
more fancy configuration such as the [[https://gitlab.inria.fr/solverstack/mini-examples/mini-chameleon/-/blob/master/.dir-locals.el][~init-evil.el~]] provided at the
