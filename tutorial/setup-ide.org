...
#+begin_src bash :eval no
  cd ./mini-chameleon
  mkdir -p build/debug/
  cmake . -B build/debug/ -DCMAKE_EXPORT_COMPILE_COMMANDS=ON -DCMAKE_BUILD_TYPE=Debug -DENABLE_MPI=ON -DENABLE_STARPU=ON -DENABLE_MIPP=ON
...
#+begin_src bash :eval no
  ...
  cmake . -B build/debug-cuda/ -DCMAKE_EXPORT_COMPILE_COMMANDS=ON -DCMAKE_BUILD_TYPE=Debug -DENABLE_MPI=ON -DENABLE_STARPU=ON -DENABLE_MIPP=ON -DENABLE_CUDA=ON
