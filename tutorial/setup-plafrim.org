...
The software environment may be handled via either [[https://modules.readthedocs.io/en/latest/][environment modules]] or [[guix.gnu.org/][guix]].
...
Because [[guix.gnu.org/][guix]] is available on =plafrim=, the [[./setup-cisd.org][guix setup]] can also be used. An
...
If you choose this method, please proceed with the [[./setup-cisd.org][guix setup]].
