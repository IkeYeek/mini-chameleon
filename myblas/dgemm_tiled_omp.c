...
int dgemm_tiled_omp(CBLAS_LAYOUT layout, CBLAS_TRANSPOSE transA,
      ...
      for (m = 0; m < MT; m++) {
        ...
        for (n = 0; n < NT; n++) {
          ...
          for (k = 0; k < KT; k++) {
            ...
            lbeta = (k == 0) ? beta : 1.;
            dgemm_seq(CblasColMajor, transA, transB, mm, nn, kk, alpha,
                      A[MT * k + m], b, B[KT * n + k], b, lbeta, C[MT * n + m],
                      b);
          }
        }
      }
      ...
      for (m = 0; m < MT; m++) {
        ...
        for (n = 0; n < NT; n++) {
          ...
          for (k = 0; k < KT; k++) {
            ...
            lbeta = (k == 0) ? beta : 1.;
            dgemm_seq(CblasColMajor, transA, transB, mm, nn, kk, alpha,
                      A[MT * k + m], b, B[NT * k + n], b, lbeta, C[MT * n + m],
                      b);
          }
        }
      }
      ...
      for (m = 0; m < MT; m++) {
        ...
        for (n = 0; n < NT; n++) {
          ...
          for (k = 0; k < KT; k++) {
            ...
            lbeta = (k == 0) ? beta : 1.;
            dgemm_seq(CblasColMajor, transA, transB, mm, nn, kk, alpha,
                      A[KT * m + k], b, B[KT * n + k], b, lbeta, C[MT * n + m],
                      b);
          }
        }
      }
      ...
      for (m = 0; m < MT; m++) {
        ...
        for (n = 0; n < NT; n++) {
          ...
          for (k = 0; k < KT; k++) {
            ...
            lbeta = (k == 0) ? beta : 1.;
            dgemm_seq(CblasColMajor, transA, transB, mm, nn, kk, alpha,
                      A[KT * m + k], b, B[NT * k + n], b, lbeta, C[MT * n + m],
                      b);
          }
        }
      }
...
static dgemm_tiled_fct_t valid_dgemm_tiled_omp __attribute__((unused)) =
    dgemm_tiled_omp;
...
void dgemm_tiled_omp_init(void) {
